...
[assembly: AssemblyDescription("Программа для ведения домашней бухгалтерии. Написано для себя и под свои нужды. Так, как удобно мне. Программа распространяется по принципу AS IS. Все вопросы - https://vk.com/arxont")]
